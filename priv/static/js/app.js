...
/* harmony import */ var _water_cooler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./water_cooler */ "./js/water_cooler.js");
...
_water_cooler__WEBPACK_IMPORTED_MODULE_3__["default"].init(_socket__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
var WaterCooler = {
  ...
  listenForChats: function listenForChats(channel) {
    ...
    channel.on('shout', function (payload) {
      var msgBlock = document.getElementById("chat-box");
      msgBlock.insertAdjacentHTML('afterbegin', "<div class=\"box\"><b>".concat(payload.name, "</b> Agora mesmo <br> ").concat(payload.body, "</div>"));
    });
  }
};
/* harmony default export */ __webpack_exports__["default"] = (WaterCooler);
